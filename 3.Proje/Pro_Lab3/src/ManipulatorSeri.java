...
public class ManipulatorSeri implements ManipulatorRobot {
	...
	public ManipulatorSeri(){
		
	}

	public ManipulatorSeri(int motorSayisi, String robotTipi, float yukTasimaKapasitesi, float tasimaHizi,
			float kolUzunlugu) 
	{
